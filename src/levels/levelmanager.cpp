...
void LevelManager::loadLevels() {
    ...
    // 教学：完整的 till→plant→water→wait→harvest 流程
    {
        ...
        l.levelId = 1;
        l.name = u"初次耕种"_qs;
        l.description = u"学习完整的耕种流程：犁地→种植→浇水→等待→收割。目标：收获小麦×1"_qs;
        l.gridW = 1; l.gridH = 1;
        l.maxTimeSec = 300;
        ...
        l.goals = {
            ...
            {u"40 秒内完成"_qs, GoalType::TimeLimit, "", 40, 0, false, StarTier::Star2},
    ...
    // 教学：二维移动 + 多格耕种
    {
        ...
        l.levelId = 2;
        l.name = u"田字初耕"_qs;
        l.description = u"在2×2网格上学习二维移动和耕种。目标：收获小麦×4"_qs;
        l.gridW = 2; l.gridH = 2;
        l.maxTimeSec = 300;
        ...
        l.goals = {
            ...
            {u"50 秒内完成"_qs, GoalType::TimeLimit, "", 50, 0, false, StarTier::Star3}
        };
        levels_[2] = l;
    }
    ...
    // 教学：for + range 简化重复代码，遇到障碍物绕行
    {
        ...
        l.levelId = 3;
        l.name = u"循环耕田"_qs;
        l.description = u"用 for 循环在3×3网格上批量耕种，注意绕开岩石。目标：收获小麦×8"_qs;
        l.gridW = 3; l.gridH = 3;
        l.maxTimeSec = 300;
        ...
        l.goals = {
            {u"收获小麦 × 8"_qs, GoalType::HarvestCount, "wheat", 8, 0, false, StarTier::Star1},
            {u"120 秒内完成"_qs, GoalType::TimeLimit, "", 120, 0, false, StarTier::Star2},
            {u"70 秒内完成"_qs, GoalType::TimeLimit, "", 70, 0, false, StarTier::Star3}
        };
        levels_[3] = l;
    }
    ...
    // 教学：胡萝卜需要更多水，且过涝会受伤
    {
        ...
        l.levelId = 4;
        l.name = u"认识胡萝卜"_qs;
        l.description = u"胡萝卜需要更多水分，但浇水过多会过涝受伤！目标：收获小麦×2、胡萝卜×6"_qs;
        l.gridW = 3; l.gridH = 3;
        l.maxTimeSec = 300;
        ...
        l.goals = {
            {u"收获小麦 × 2"_qs, GoalType::HarvestCount, "wheat", 2, 0, false, StarTier::Star1},
            {u"收获胡萝卜 × 6"_qs, GoalType::HarvestCount, "carrot", 6, 0, false, StarTier::Star1},
            {u"150 秒内完成"_qs, GoalType::TimeLimit, "", 150, 0, false, StarTier::Star2},
            {u"100 秒内完成"_qs, GoalType::TimeLimit, "", 100, 0, false, StarTier::Star3}
        };
        levels_[4] = l;
    }
    ...
    // 教学：def 封装重复逻辑
    {
        ...
        l.levelId = 5;
        l.name = u"函数封装"_qs;
        l.description = u"用 def 定义函数封装耕种流程。目标：收获小麦×8、胡萝卜×8"_qs;
        l.gridW = 4; l.gridH = 4;
        l.maxTimeSec = 300;
        ...
        l.goals = {
            {u"收获小麦 × 8"_qs, GoalType::HarvestCount, "wheat", 8, 0, false, StarTier::Star1},
            {u"收获胡萝卜 × 8"_qs, GoalType::HarvestCount, "carrot", 8, 0, false, StarTier::Star1},
            {u"180 秒内完成"_qs, GoalType::TimeLimit, "", 180, 0, false, StarTier::Star2},
            {u"120 秒内完成"_qs, GoalType::TimeLimit, "", 120, 0, false, StarTier::Star3}
        };
        levels_[5] = l;
    }
    ...
    // 教学：fertilize 加速生长
    {
        ...
        l.levelId = 6;
        l.name = u"施肥加速"_qs;
        l.description = u"施肥可加速作物生长 1.5-1.8 倍。目标：收获小麦×14"_qs;
        l.gridW = 4; l.gridH = 4;
        l.maxTimeSec = 180;
        ...
        l.goals = {
            {u"收获小麦 × 14"_qs, GoalType::HarvestCount, "wheat", 14, 0, false, StarTier::Star1},
            {u"120 秒内完成"_qs, GoalType::TimeLimit, "", 120, 0, false, StarTier::Star2},
            {u"80 秒内完成"_qs, GoalType::TimeLimit, "", 80, 0, false, StarTier::Star3}
        };
        levels_[6] = l;
    }
    ...
    // 教学：番茄需要二次浇水
    {
        ...
        l.levelId = 7;
        l.name = u"番茄挑战"_qs;
        l.description = u"番茄初始水分较少，需要更早补浇。目标：收获小麦×3、胡萝卜×3、番茄×7"_qs;
        l.gridW = 4; l.gridH = 4;
        l.maxTimeSec = 300;
        ...
        l.goals = {
            ...
            {u"收获胡萝卜 × 3"_qs, GoalType::HarvestCount, "carrot", 3, 0, false, StarTier::Star1},
            {u"收获番茄 × 7"_qs, GoalType::HarvestCount, "tomato", 7, 0, false, StarTier::Star1},
            {u"180 秒内完成"_qs, GoalType::TimeLimit, "", 180, 0, false, StarTier::Star2},
            {u"120 秒内完成"_qs, GoalType::TimeLimit, "", 120, 0, false, StarTier::Star3}
        };
        levels_[7] = l;
    ...
    // 教学：while 循环持续巡逻
    {
        ...
        l.levelId = 8;
        l.name = u"循环优化"_qs;
        l.description = u"用 while 循环优化耕种和巡逻逻辑。目标：收获小麦×6、番茄×6"_qs;
        l.gridW = 4; l.gridH = 4;
        l.maxTimeSec = 300;
        ...
        l.goals = {
            {u"收获小麦 × 6"_qs, GoalType::HarvestCount, "wheat", 6, 0, false, StarTier::Star1},
            {u"收获番茄 × 6"_qs, GoalType::HarvestCount, "tomato", 6, 0, false, StarTier::Star1},
            {u"150 秒内完成"_qs, GoalType::TimeLimit, "", 150, 0, false, StarTier::Star2},
            {u"100 秒内完成"_qs, GoalType::TimeLimit, "", 100, 0, false, StarTier::Star3}
        };
        levels_[8] = l;
    ...
    // 教学：spray() 杀虫，虫害区概念
    {
        ...
        l.levelId = 9;
        l.name = u"除虫入门"_qs;
        l.description = u"虫害会出现！学习用 spray() 保护作物。目标：收获番茄×14"_qs;
        l.gridW = 4; l.gridH = 4;
        l.maxTimeSec = 300;
        ...
        l.goals = {
            {u"收获番茄 × 14"_qs, GoalType::HarvestCount, "tomato", 14, 0, false, StarTier::Star1},
            {u"240 秒内完成"_qs, GoalType::TimeLimit, "", 240, 0, false, StarTier::Star2},
            {u"150 秒内完成"_qs, GoalType::TimeLimit, "", 150, 0, false, StarTier::Star3}
        };
        levels_[9] = l;
    }
    ...
    // 教学：玉米生长慢，旱灾惩罚，持续供水
    {
        ...
        l.levelId = 10;
        l.name = u"玉米种植"_qs;
        l.description = u"玉米生长慢且缺水会损失进度，需要持续供水。目标：收获玉米×23"_qs;
        l.gridW = 5; l.gridH = 5;
        l.maxTimeSec = 300;
        ...
        l.goals = {
            {u"收获玉米 × 23"_qs, GoalType::HarvestCount, "corn", 23, 0, false, StarTier::Star1},
            {u"240 秒内完成"_qs, GoalType::TimeLimit, "", 240, 0, false, StarTier::Star2},
            {u"150 秒内完成"_qs, GoalType::TimeLimit, "", 150, 0, false, StarTier::Star3}
        };
        levels_[10] = l;
    ...
    // 教学：持续巡逻模式，多作物管理
    {
        ...
        l.levelId = 11;
        l.name = u"巡逻防线"_qs;
        l.description = u"用循环持续巡逻，保护所有作物不受虫害。目标：收获小麦×8、番茄×7、玉米×7"_qs;
        l.gridW = 5; l.gridH = 5;
        l.maxTimeSec = 300;
        ...
        l.goals = {
            {u"收获小麦 × 8"_qs, GoalType::HarvestCount, "wheat", 8, 0, false, StarTier::Star1},
            {u"收获番茄 × 7"_qs, GoalType::HarvestCount, "tomato", 7, 0, false, StarTier::Star1},
            {u"收获玉米 × 7"_qs, GoalType::HarvestCount, "corn", 7, 0, false, StarTier::Star1},
            {u"240 秒内完成"_qs, GoalType::TimeLimit, "", 240, 0, false, StarTier::Star2},
            {u"150 秒内完成"_qs, GoalType::TimeLimit, "", 150, 0, false, StarTier::Star3}
        };
        levels_[11] = l;
    ...
    // 教学：and/or/not, else
    {
        ...
        l.levelId = 12;
        l.name = u"布尔逻辑"_qs;
        l.description = u"用 and、or、not 组合复杂条件判断。目标：收获小麦×6、胡萝卜×5、番茄×6、玉米×5"_qs;
        l.gridW = 5; l.gridH = 5;
        l.maxTimeSec = 300;
        ...
        l.goals = {
            {u"收获小麦 × 6"_qs, GoalType::HarvestCount, "wheat", 6, 0, false, StarTier::Star1},
            {u"收获胡萝卜 × 5"_qs, GoalType::HarvestCount, "carrot", 5, 0, false, StarTier::Star1},
            {u"收获番茄 × 6"_qs, GoalType::HarvestCount, "tomato", 6, 0, false, StarTier::Star1},
            {u"收获玉米 × 5"_qs, GoalType::HarvestCount, "corn", 5, 0, false, StarTier::Star1},
            {u"240 秒内完成"_qs, GoalType::TimeLimit, "", 240, 0, false, StarTier::Star2},
            {u"150 秒内完成"_qs, GoalType::TimeLimit, "", 150, 0, false, StarTier::Star3}
        };
        levels_[12] = l;
    ...
    // 教学：break/continue 优化巡逻
    {
        ...
        l.levelId = 13;
        l.name = u"高级控制"_qs;
        l.description = u"用 break 和 continue 优化巡逻逻辑。目标：收获玉米×21"_qs;
        l.gridW = 5; l.gridH = 5;
        l.maxTimeSec = 240;
        ...
        l.goals = {
            {u"收获玉米 × 21"_qs, GoalType::HarvestCount, "corn", 21, 0, false, StarTier::Star1},
            {u"180 秒内完成"_qs, GoalType::TimeLimit, "", 180, 0, false, StarTier::Star2},
            {u"120 秒内完成"_qs, GoalType::TimeLimit, "", 120, 0, false, StarTier::Star3}
        };
        levels_[13] = l;
    ...
    // 教学：return, get_goals(), 大地图路径规划
    {
        ...
        l.levelId = 14;
        l.name = u"路径规划"_qs;
        l.description = u"在6×6大地图上规划高效耕种路径。目标：收获小麦×8、胡萝卜×8、番茄×8、玉米×7"_qs;
        l.gridW = 6; l.gridH = 6;
        l.maxTimeSec = 300;
        ...
        l.goals = {
            {u"收获小麦 × 8"_qs, GoalType::HarvestCount, "wheat", 8, 0, false, StarTier::Star1},
            {u"收获胡萝卜 × 8"_qs, GoalType::HarvestCount, "carrot", 8, 0, false, StarTier::Star1},
            {u"收获番茄 × 8"_qs, GoalType::HarvestCount, "tomato", 8, 0, false, StarTier::Star1},
            {u"收获玉米 × 7"_qs, GoalType::HarvestCount, "corn", 7, 0, false, StarTier::Star1},
            {u"240 秒内完成"_qs, GoalType::TimeLimit, "", 240, 0, false, StarTier::Star2},
            {u"150 秒内完成"_qs, GoalType::TimeLimit, "", 150, 0, false, StarTier::Star3}
        };
    ...
    // 教学：向日葵的阳光加成和过涝致命
    {
        ...
        l.levelId = 15;
        l.name = u"向日葵入门"_qs;
        l.description = u"向日葵为周围作物提供阳光加成，但过涝会致命。目标：收获番茄×33"_qs;
        l.gridW = 6; l.gridH = 6;
        l.maxTimeSec = 300;
        ...
        l.goals = {
            {u"收获番茄 × 33"_qs, GoalType::HarvestCount, "tomato", 33, 0, false, StarTier::Star1},
            {u"240 秒内完成"_qs, GoalType::TimeLimit, "", 240, 0, false, StarTier::Star2},
            {u"180 秒内完成"_qs, GoalType::TimeLimit, "", 180, 0, false, StarTier::Star3}
        };
        levels_[15] = l;
    }
    ...
    // 教学：向日葵布局优化
    {
        ...
        l.levelId = 16;
        l.name = u"阳光规划"_qs;
        l.description = u"合理布局向日葵，最大化阳光加成覆盖。目标：收获玉米×31"_qs;
        l.gridW = 6; l.gridH = 6;
        l.maxTimeSec = 300;
        ...
        l.goals = {
            {u"收获玉米 × 31"_qs, GoalType::HarvestCount, "corn", 31, 0, false, StarTier::Star1},
            {u"240 秒内完成"_qs, GoalType::TimeLimit, "", 240, 0, false, StarTier::Star2},
            {u"180 秒内完成"_qs, GoalType::TimeLimit, "", 180, 0, false, StarTier::Star3}
        };
        levels_[16] = l;
    ...
    // 教学：限时高效耕种
    {
        ...
        l.levelId = 17;
        l.name = u"效率挑战"_qs;
        l.description = u"限时内高效管理多种作物和向日葵。目标：收获小麦×15、玉米×15"_qs;
        l.gridW = 6; l.gridH = 6;
        l.maxTimeSec = 240;
        ...
        l.goals = {
            {u"收获小麦 × 15"_qs, GoalType::HarvestCount, "wheat", 15, 0, false, StarTier::Star1},
            {u"收获玉米 × 15"_qs, GoalType::HarvestCount, "corn", 15, 0, false, StarTier::Star1},
            {u"180 秒内完成"_qs, GoalType::TimeLimit, "", 180, 0, false, StarTier::Star2},
            {u"120 秒内完成"_qs, GoalType::TimeLimit, "", 120, 0, false, StarTier::Star3}
        };
        levels_[17] = l;
    ...
    // 教学：大规模综合管理
    {
        ...
        l.levelId = 18;
        l.name = u"大农场"_qs;
        l.description = u"7×7大农场，综合运用所有技能。目标：收获小麦×10、胡萝卜×10、番茄×10、玉米×10"_qs;
        l.gridW = 7; l.gridH = 7;
        l.maxTimeSec = 360;
        ...
        l.goals = {
            {u"收获小麦 × 10"_qs, GoalType::HarvestCount, "wheat", 10, 0, false, StarTier::Star1},
            {u"收获胡萝卜 × 10"_qs, GoalType::HarvestCount, "carrot", 10, 0, false, StarTier::Star1},
            {u"收获番茄 × 10"_qs, GoalType::HarvestCount, "tomato", 10, 0, false, StarTier::Star1},
            {u"收获玉米 × 10"_qs, GoalType::HarvestCount, "corn", 10, 0, false, StarTier::Star1},
            {u"270 秒内完成"_qs, GoalType::TimeLimit, "", 270, 0, false, StarTier::Star2},
            {u"200 秒内完成"_qs, GoalType::TimeLimit, "", 200, 0, false, StarTier::Star3}
        };
        levels_[18] = l;
    }
    ...
    // 教学：极限效率挑战
    {
        ...
        l.levelId = 19;
        l.name = u"极限耕种"_qs;
        l.description = u"7×7大农场限时挑战，极限效率。目标：收获玉米×42"_qs;
        l.gridW = 7; l.gridH = 7;
        l.maxTimeSec = 300;
        ...
        l.goals = {
            {u"收获玉米 × 42"_qs, GoalType::HarvestCount, "corn", 42, 0, false, StarTier::Star1},
            {u"240 秒内完成"_qs, GoalType::TimeLimit, "", 240, 0, false, StarTier::Star2},
            {u"180 秒内完成"_qs, GoalType::TimeLimit, "", 180, 0, false, StarTier::Star3}
        };
        levels_[19] = l;
    ...
    // 教学：全 API + 全作物 + 全机制
    {
        ...
        l.levelId = 20;
        l.name = u"终极农场"_qs;
        l.description = u"8×8 终极农场，综合运用所有技能。目标：收获小麦×14、胡萝卜×14、番茄×14、玉米×14"_qs;
        l.gridW = 8; l.gridH = 8;
        l.maxTimeSec = 420;
        ...
        l.goals = {
            {u"收获小麦 × 14"_qs, GoalType::HarvestCount, "wheat", 14, 0, false, StarTier::Star1},
            {u"收获胡萝卜 × 14"_qs, GoalType::HarvestCount, "carrot", 14, 0, false, StarTier::Star1},
            {u"收获番茄 × 14"_qs, GoalType::HarvestCount, "tomato", 14, 0, false, StarTier::Star1},
            {u"收获玉米 × 14"_qs, GoalType::HarvestCount, "corn", 14, 0, false, StarTier::Star1},
            {u"330 秒内完成"_qs, GoalType::TimeLimit, "", 330, 0, false, StarTier::Star2},
            {u"240 秒内完成"_qs, GoalType::TimeLimit, "", 240, 0, false, StarTier::Star3}
        };
        levels_[20] = l;
    }
}
