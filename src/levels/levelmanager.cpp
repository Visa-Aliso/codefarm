...
void LevelManager::loadLevels() {
    ...
    // 教学：and/or 组合条件、fertilize、番茄
    {
        ...
        l.levelId = 7;
        l.name = u"施肥"_s;
        l.description = u"施肥加速 1.5-1.8 倍。用 and/or 组合多个条件。目标：收获小麦×4、胡萝卜×4、番茄×6"_s;
        l.gridW = 4; l.gridH = 4;
        l.maxTimeSec = 300;
